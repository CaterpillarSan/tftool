...
export const combinedItems = {
  ...
  '2-4': { id: 'crownpledge', name: 'クラウンの誓い', icon: 'colossus.png', components: ['chainvest', 'needlesslylargerod'], hiragana: 'くらうんのちかい', romaji: 'kuraunnochikai' },
  ...
  '2-7': { id: 'steadfastheart', name: '揺るがぬ心', icon: 'shroudofstillness.png', components: ['chainvest', 'sparringgloves'], hiragana: 'ゆるがぬこころ', romaji: 'yuruganukokoro' },
  ...
  '3-6': { id: 'evenshroud', name: 'イーブン シュラウド', icon: 'colossus.png', components: ['negatroncloak', 'giantsbelt'], hiragana: 'いーぶんしゅらうど', romaji: 'ibunshuuraudo' },
  ...
  '6-3': { id: 'evenshroud', name: 'イーブン シュラウド', icon: 'colossus.png', components: ['giantsbelt', 'negatroncloak'], hiragana: 'いーぶんしゅらうど', romaji: 'ibunshuuraudo' },
  ...
  '6-7': { id: 'strikersflail', name: 'ストライカーフレイル', icon: 'redemption.png', components: ['giantsbelt', 'sparringgloves'], hiragana: 'すとらいかーふれいる', romaji: 'sutoraikafureiru' },
  ...
  '7-6': { id: 'strikersflail', name: 'ストライカーフレイル', icon: 'redemption.png', components: ['sparringgloves', 'giantsbelt'], hiragana: 'すとらいかーふれいる', romaji: 'sutoraikafureiru' },
